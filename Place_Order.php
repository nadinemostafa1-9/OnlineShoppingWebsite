  ...
  <form class="place-order">
    <div id="callout" class="callout">
      ...
      <div class="callout-container">
        ...
        <p name="" class="check-info">Misr Elgedeeda</p>
        <br>
        <p class="check-info"><b>Phone Number:  </b></p>
        <p name="" class="check-info">12345678910</p>
        <br>
        <p class="check-info"><b>Delivery Fees: </b></p>
        <p name="" class="check-info">500 LE</p>
        <br>
        <p class="check-info"><b>Payment Method: </b></p>
        <p name="" class="check-info">Cash</p>
        <br>
        <p class="check-info"><b>Discount: </b></p>
        <p name="" class="check-info">No Discount</p>
        <br>
        <p class="check-info"><b>Total: </b></p>
        <p name="" class="check-info">5000LE</p>
        <br>
        <div class="place">
          <button class="p-order">Place Order</button>
        </div>
      </div>
    </div>
  </form>
