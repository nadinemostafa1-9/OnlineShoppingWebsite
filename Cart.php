...
<div class="card-group">
       <div class=col-md-12>
        <div class="card">
          <a href="cardtest.html">
            <img src="Ripped Boyfriend Sleeveless Denim Vest - Light Green.PNG" class="card-img-top" alt="...">
          </a>
          <div class="card-body">
          <h3 class="card-title">Black  Cross Leather Bag</h3>
          <p class="item-price">$price</p>
          </div>
          <div class="add-btn">
             <input class="quan" placeholder="Number of items" type="number" id="quantity" name="quantity" min="1">
             <button href="#" class="card-btn">Remove</button>
          </div>
          </div>
       </div>
  ...
  <div>
    ...
    total=$price
                  ...
                  <div class="add-btn2">
                   <button href="#" class="card-btn">Complete the order</button>
                   <button href="#" class="carde-btn">Cancel</button>
                  </div>
                  <br>
   </form>
