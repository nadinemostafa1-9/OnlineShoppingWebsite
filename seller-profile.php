 ...
 <div class="container">
  ...
  <p class="changepass">Change Password?</p>
    <div class="form-group">
      ...
      <input class="in" type="password" placeholder="Enter Password" id="currentPassword" name="psw" required>
     <label for="psw"><b>New Password</b></label>
      <input class="in" type="password" placeholder="Enter Password" id="newPassword" name="psw" required>
      <label for="psw"><b>Confirm New Password</b></label>
       <input class="in" type="password" placeholder="Confirm Password" id="confirmPassword" name="psw" required>
    </div>
    <!-----for buttons--->
