	...
	<body>
      ...
      $mPDO=connecting();
        ...
        $prepare->execute();
				...
				?>
			<div class="col-md-4">
				<form method="post" action="cartController.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="cartController.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
