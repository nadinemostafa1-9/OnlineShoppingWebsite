...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
  ...
  <path fill-rule="evenodd" d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
   ...
   <!------form---->
 <div class="container">
    <form class="form-horizontal k">
         <h2 class="hh">Report a problem</h2>
    <div class="form-group">
      <label class="emaildesign" for="email"><b>Email</b></label>
      
   <div class="inpu"><input class="form-control" type="email" placeholder="Enter Email"  required></div>
    </div><!-----write problem---->
    <div class="form-group">
  <label for="problem" class="prob">Write your problem:</label>
 <div class ="d"> <textarea class="form-control  " rows="5" id="comment"></textarea></div>
</div>
    <!--------- button edit------>
 <div class="buttonsdesign">
   <button type="submit" class="sub " data-toggle="collapse" data-target="#demo" required>Submit</button>
